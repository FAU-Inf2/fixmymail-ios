...
- (void)viewDidLoad {
    ...
    [_messageView setMessage:self.parser];
...
- (MCOIMAPFetchContentOperation *) _fetchIMAPPartWithUniqueID:(NSString *)partUniqueID folder:(NSString *)folder
{
    ...
    MCOIMAPFetchContentOperation * op = [_session fetchMessageAttachmentOperationWithFolder:folder
                                                                                     number:[_message uid]
                                                                                     partID:[part partID]
