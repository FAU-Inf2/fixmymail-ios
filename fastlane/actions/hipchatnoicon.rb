module Fastlane
  module Actions
    ...
    class HipchatnoiconAction < Action
      def self.run(options)
        ...
        message = (options[:show_icon] ? "<table><tr><td><img src='https://s3-eu-west-1.amazonaws.com/fastlane.tools/fastlane.png' width='50' height='50'></td><td>#{the_message[0..9999]}</td></tr></table>"
                                     : "#{the_message[0..9999]}")
      ...
      def self.available_options
        [
          ...
          FastlaneCore::ConfigItem.new(key: :show_icon,
                                       env_name: "FL_HIPCHAT_SHOW_ICON",
                                       description: "Show the fastlane logo in the message? (true/false)",
                                       optional: true,
                                       default_value: true,
                                       is_string: false)
          ]
